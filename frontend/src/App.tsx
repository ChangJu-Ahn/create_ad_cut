            ...
            <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
                <div className="max-w-screen-2xl mx-auto px-4 h-14 flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-2">
                        <Link
                            to="/gallery"
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-slate-700 hover:bg-slate-100 transition"
                        >
                            생성 이력
                        </Link>
                        <Link
                            to="/"
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm bg-slate-900 text-white hover:bg-slate-800 transition"
                        >
                            새로 만들기
                        </Link>
                    </nav>
